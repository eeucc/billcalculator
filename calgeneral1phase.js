    ...
    if (
      ...
      switch (year) {
        ...
        case "":
          ...
          if (quarter == "Quarter1") {
            energy_bill = consumption * tariff17.Q1[7];
            service_charge = service17.Q1[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff17.Q1[7]) + service_charge) * 0.15;
          } else if (quarter == "Quarter2") {
            energy_bill = consumption * tariff17.Q2[7];
            service_charge = service17.Q2[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff17.Q2[7]) + service_charge) * 0.15;
          } else if (quarter == "Quarter3") {
            energy_bill = consumption * tariff17.Q3[7];
            service_charge = service17.Q3[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff17.Q3[7]) + service_charge) * 0.15;
          } else if (quarter == "Quarter4") {
            energy_bill = consumption * tariff17.Q4[7];
            service_charge = service17.Q4[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff17.Q4[7]) + service_charge) * 0.15;
          }
          break;
        case "2018":
          ...
          if (quarter == "Quarter1") {
            energy_bill = consumption * tariff18.Q1[7];
            service_charge = service18.Q1[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff18.Q1[7]) + service_charge) * 0.15;
          } else if (quarter == "Quarter2") {
            energy_bill = consumption * tariff18.Q2[7];
            service_charge = service18.Q2[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff18.Q2[7]) + service_charge) * 0.15;
          } else if (quarter == "Quarter3") {
            energy_bill = consumption * tariff18.Q3[7];
            service_charge = service18.Q3[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff18.Q3[7]) + service_charge) * 0.15;
          } else if (quarter == "Quarter4") {
            energy_bill = consumption * tariff18.Q4[7];
            service_charge = service18.Q4[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff18.Q4[7]) + service_charge) * 0.15;
          }
          break;
        case "2019":
          ...
          if (quarter == "Quarter1") {
            energy_bill = consumption * tariff19.Q1[7];
            service_charge = service19.Q1[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff19.Q1[7]) + service_charge) * 0.15;
          } else if (quarter == "Quarter2") {
            energy_bill = consumption * tariff19.Q2[7];
            service_charge = service19.Q2[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff19.Q2[7]) + service_charge) * 0.15;
          } else if (quarter == "Quarter3") {
            energy_bill = consumption * tariff19.Q3[7];
            service_charge = service19.Q3[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff19.Q3[7]) + service_charge) * 0.15;
          } else if (quarter == "Quarter4") {
            energy_bill = consumption * tariff19.Q4[7];
            service_charge = service19.Q4[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff19.Q4[7]) + service_charge) * 0.15;
          }
          break;
        case "2020":
          ...
          if (quarter == "Quarter1") {
            energy_bill = consumption * tariff20.Q1[7];
            service_charge = service20.Q1[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff20.Q1[7]) + service_charge) * 0.15;
          } else if (quarter == "Quarter2") {
            energy_bill = consumption * tariff20.Q2[7];
            service_charge = service20.Q2[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff20.Q2[7]) + service_charge) * 0.15;
          } else if (quarter == "Quarter3") {
            energy_bill = consumption * tariff20.Q3[7];
            service_charge = service20.Q3[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff20.Q3[7]) + service_charge) * 0.15;
          } else if (quarter == "Quarter4") {
            energy_bill = consumption * tariff20.Q4[7];
            service_charge = service20.Q4[4];
            reg_fee = (energy_bill + service_charge) * 0.005;
            vat = ((consumption * tariff20.Q4[7]) + service_charge) * 0.15;
          }
          break;
        default:
          break;
